  ...
  en: {
    ...
    credentials: {
      ...
      cards: [
        ...
        { type: "listed", mark: "Σ", markClass: "sixsigma", title: "Lean Six Sigma Yellow Belt", issuer: "CV-listed certification", note: "Included in the supplied CV. Candidate-supplied APMG International Lean Six Sigma Yellow Belt Foundation badge shown.", file: "assets/cv/gabriel-saunero-cv-en.pdf", badge: "assets/badges/lean-six-sigma-yellow-belt-apmg.png", badgeAlt: "APMG International Lean Six Sigma Yellow Belt Foundation badge" },
        { type: "listed", mark: "eS", markClass: "ecopy", title: "eCopy ShareScan 6 Technical Certification", issuer: "LinkedIn-listed certification", note: "Certification listed in the supplied LinkedIn profile export. Candidate-supplied eCopy ShareScan logo shown.", file: "assets/cv/linkedin-profile.pdf", badge: "assets/badges/ecopy-sharescan-logo.png", badgeAlt: "eCopy ShareScan logo" },
  ...
  es: {
    ...
    credentials: {
      ...
      cards: [
        ...
        { type: "listed", mark: "Σ", markClass: "sixsigma", title: "Lean Six Sigma Yellow Belt", issuer: "Certificación listada en CV", note: "Incluida en el CV suministrado. Se muestra el badge APMG International Lean Six Sigma Yellow Belt Foundation proporcionado por el candidato.", file: "assets/cv/gabriel-saunero-cv-en.pdf", badge: "assets/badges/lean-six-sigma-yellow-belt-apmg.png", badgeAlt: "Badge APMG International Lean Six Sigma Yellow Belt Foundation" },
        { type: "listed", mark: "eS", markClass: "ecopy", title: "eCopy ShareScan 6 Technical Certification", issuer: "Certificación listada en LinkedIn", note: "Certificación listada en el PDF de perfil de LinkedIn suministrado. Se muestra el logo eCopy ShareScan proporcionado por el candidato.", file: "assets/cv/linkedin-profile.pdf", badge: "assets/badges/ecopy-sharescan-logo.png", badgeAlt: "Logo eCopy ShareScan" },
